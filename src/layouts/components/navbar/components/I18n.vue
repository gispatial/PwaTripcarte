<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('fr')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/en.png" alt="fr" /> &nbsp;B.Malaysia</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
...
export default {
  computed: {
    ...
    getCurrentLocaleData() {
        ...
        else if (locale == "my") return { flag: "us", lang: 'Bahasa_Malaysia'     }
